...
export const WorkSticker: React.FC<WorkStickerProps> = ({ onAddClick }) => {
  return (
    <div
      onClick={onAddClick}
      className="bg-[#FFE600] border-[3.5px] border-[#111111] rounded-2xl p-6 shadow-[6px_6px_0px_#111111] transition-all cursor-pointer relative overflow-hidden group hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[3px_3px_0px_#111111] select-none"
    >
