...
export const AboutSection: React.FC = () => {
  return (
    <section
      id="about"
      className="mt-12 mb-8 border-2 border-black bg-white p-5 sm:p-8 shadow-[4px_4px_0px_#000000] text-black scroll-mt-20"
    >
      {/* Header Banner */}
      <div className="border-b-2 border-black pb-6">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black uppercase tracking-tight text-black leading-tight">
            ...
            <div className="md:col-span-4 flex flex-col items-center">
              <div className="border-2 border-black bg-[#F3F3F3] p-2 shadow-[4px_4px_0px_#000000] w-full max-w-[280px]">
                ...
                <div className="mt-2.5 px-1 text-center">
                  <h4 className="text-sm font-black uppercase text-black">Prof. Abdul Bari</h4>
